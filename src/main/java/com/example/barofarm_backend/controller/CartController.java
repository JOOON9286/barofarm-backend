...
public class CartController {
    ...
    // 장바구니에 상품 추가
    @PostMapping("/add")
    public ResponseEntity<String> addItem(@RequestBody CartAddItemRequest request) {
    ...
    // 장바구니 수량 변경
    @PutMapping("/update")
    public ResponseEntity<String> updateItem(@RequestBody CartUpdateItemRequest request) {
